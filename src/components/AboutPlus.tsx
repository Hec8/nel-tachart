...
const AboutPlus = () => {
    ...
    const content = [
        {
            text: [
                "Leonel ZADJI est un Artiste peintre plasticien béninois, autodidacte, né le 1er Mars en 1997 à Cotonou au Bénin. Il a grandi dans les environs de la Place de l'Etoile Rouge en plein centre-vill et réside actuellement à Dèkoungbé un quartier populaire de Cotonou, où son univers est confiné dans un atelier.",
        ...
        },
        {
            text: [
                ...
                "En outre, en 2020, Leonel ZADJI a participé à l'exposition AFRODISIAC. Il réalise la même année le portrait d'un lion en abstrait sur du verre clair pour le compte de l'Agence de communication JAWUNTAA, productrice de la première série de téléréalité au Bénin.",
                "Il devient ensuite l'un de leurs sponsors pour les saisons 3 en 2020 et 4 en 2021 de l'émission DIS MOI QUI EST LA PLUS BELLE, en offrant un tableau de verre à chaque Reine d'or. Ce qui le met en valeur à l'international à travers Canal 3, la chaine de télé qui diffuse l'émission, qu'on peut capter avec Canal+, ce qui signifie qu'une forte audience aurait remarqué la publicité du travail de Leonel ZADJI."
            ],
            image: image3
        },
        ...
        {
            text: [
                " L'artiste décide donc de s'en inspirer pour retransmettre à travers ses tableaux une qualité de message qui évoque essentiellement les problèmes au quotidien des africains ainsi que la solution qu'il y propose, c'est-à-dire la renaissance de l'éducation du passé à travers la mémoire collective. L'art de Leonel ZADJI sur le verre transparent tire son inspiration de figures éminentes telles",
                "que Marcel Duchamp, Simon Berger, Miquel Barceló, Pierre ANTOINE, et Christiane Lemez, tous reconnus pour leur remarquable travail dans le domaine du verre. Ces artistes renommés ont joué un rôle crucial dans la formation de la vision artistique de Leonel ZADJI, lui montrant des perspectives uniques et des techniques innovantes. En s'inspirant de leur expertise, Leonel ZADJI aspire à représenter son pays, le Bénin, sur la scène artistique",
        ...
        {
            text: [
                "  Leonel souhaite éveiller la créativité des enfants en les attirant grâce aux couleurs, les chiffres et symboles.Il voit son art comme un moyen de transmettre des messages puissants sur l'éducation et la culture africaine. En 2023, il est récompensé en tant que Best Visual Artist lors des Open Conscience Awards. ",
                "Projets d'expositions En 2024, il est sollicité par Mr Dieudonné METONOU, promoteur du site touristique Détour par Gogotinkpon.A l'occasion de la 5ème édition du FESTILUM gbakpèzogbin, Leonel ZADJI est alors invité pour dispenser aux enfants, un atelier d'initiation à l'art  suivi d'une exposition des œuvres sur le lac dans la période des fêtes de fin d'année.",
                " Leonel ZADJI est un artiste en pleine ascension, déterminé à représenter le Bénin sur la scène artistique internationale. Avec une foi inébranlable dans son travail et un désir de continuer à évoluer, il aspire à toucher les cœurs et les esprits à travers son art unique sur verre transparent."
            ],
    ...
    return (
        <div className="mt-10 px-4 sm:px-6 lg:px-20">
            <Title title="BIOGRAPHIE DE LEONEL ZADJI" />
            <div className="bg-base-200 p-4 sm:p-6 lg:p-10 rounded-xl shadow-lg">
                <h1 className="text-2xl sm:text-3xl font-bold text-accent mb-6 text-center">
                    Leonel ZADJI - Artiste peintre plasticien
                </h1>
                    ...
                    >
                        ...
                        <div className="w-full lg:w-1/3 flex justify-center">
                            <img
                                ...
                                alt={`Exemple de travail de Leonel ZADJI ${index + 1}`}
                            />
                        </div>
